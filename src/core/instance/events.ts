...
import { formatComponentName, tip } from '../util/debug'
import { hyphenate, toArray } from '@/shared/util'
...
export function eventsMixin(Vue: typeof Component) {
  ...
  Vue.prototype.$on = function (
    ...
    if (Array.isArray(event)) {
      ...
      // optimize hook:event const by using a boolean flag marked at registration
