import type { ASTElement, CompilerOptions } from '../types/compiler'
import { cached, no, makeMap } from '@/shared/util'
...
function isDirectChildOfTemplateFor(node: ASTElement) {
  while (node.parent) {
    node = node.parent
